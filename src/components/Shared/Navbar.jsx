        ...
        <div className="mx-5 mt-7 px-[4%]">
            ...
            <div className="border-t-2 mt-6 font-medium py-3 px-[4%]">
                <div className="flex items-center justify-between">
                    ...
                    <Link
                        href="/"
                        className={`text-[16px] hover:text-red-600 ${
                            isActive('/') ? 'text-[#e07c0a] border-b-[3px] border-[#41398e]' : ''
                        }`}
                    >
                        HOME
                    </Link>
                    ...
                    <Link
                        ...
                        className={`text-[16px] hover:text-red-600 ${
                            isActive('/category/panjabi') ? 'text-[#e07c0a] border-b-[3px] border-[#41398e]' : ''
                        }`}
                    >
                        PANJABI
                    </Link>
                    ...
                    <div className="dropdown group relative">
                        <Link
                            ...
                            className={`text-[16px] flex gap-2 items-center ${
                                isActive('/category/tshirt') ? 'text-[#e07c0a] border-b-[3px] border-[#41398e]' : ''
                            }`}
                        >
                            <span>T-SHIRT</span>
                    ...
                    <Link
                        ...
                        className={`text-[16px] hover:text-red-600 ${
                            isActive('/category/polo-shirt') ? 'text-[#e07c0a] border-b-[3px] border-[#41398e]' : ''
                        }`}
                    >
                        POLO SHIRT
                    </Link>
                    ...
                    <Link
                        href="/category/boxer"
                        className={`text-[16px] hover:text-red-600 ${
                            isActive('/category/boxer') ? 'inline-block border-b-[3px] border-[#41398e] text-[#e07c0a]' : ''
                        }`}
                    >
                        BOXER
                    </Link>
                    ...
                    <div className="dropdown group relative">
                        <Link
                            ...
                            className={`text-[16px] flex gap-2 items-center ${
                                isActive('/category/winter') ? 'text-[#e07c0a] border-b-[3px] border-[#41398e]' : ''
                            }`}
                        >
                            <span>WINTER</span>
                            <IoIosArrowDown className="mt-1" />
                    ...
                    <Link
                        href="/category/shoe"
                        className={`text-[16px] hover:text-red-600 ${
                            isActive('/category/shoe') ? 'text-[#e07c0a] border-b-[3px] border-[#41398e]' : ''
                        }`}
                    >
                        SHOE
                    </Link>
                    ...
                    <Link
                        ...
                        className={`text-[16px] hover:text-red-600 ${
                            isActive('/category/summer-tracksuit-combo') ? 'text-[#e07c0a] border-b-[3px] border-[#41398e]' : ''
                        }`}
                    >
                    ...
                    <Link
                        ...
                        className={`text-[16px] hover:text-red-600 ${
                            isActive('/category/trouser') ? 'text-[#e07c0a] border-b-[3px] border-[#41398e]' : ''
                        }`}
                    >
                        TROUSER
                    </Link>
                    ...
                    <div className="dropdown group relative">
                        <Link
                            ...
                            className={`text-[16px] flex gap-2 items-center ${
                                isActive('/category/accessories') ? 'text-[#e07c0a] border-b-[3px] border-[#41398e]' : ''
                            }`}
                        >
